    ...
    <div className="pt-20 min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full px-[4%] mt-8">
        <div className="md:max-w-[60%] w-full">
          ...
          >
            <h1 className="text-2xl mb-4 dark:text-black">Let's Talk</h1>
            ...
            <label className="flex items-center">
              ...
              <span className="text-gray-600 ml-2 text-sm">
                I allow TEN AI to contact me for scheduling and marketing.
              </span>
              {errors.terms && (
        ...
        <div className="md:max-w-[40%] w-full">
          <div className="bg-[#01194c] text-white min-h-100 rounded-lg flex flex-col gap-10 px-10 py-16">
            ...
            <div className="flex flex-col gap-3">
              <span className="w-fit rounded-full text-black bg-[#d6f549] text-xs px-2 py-1">
                Location
              </span>
              <a
